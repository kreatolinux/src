...
proc package*(repo: string, package: string, release = "1", version: string,
        sources = "", depends = "", add = "build,package") =
...
proc override*(packages: seq[string], extraArguments = "", cflags = "",
        cxxflags = "", sourceMirror = "", binaryMirrors = "", ccache = false) =
