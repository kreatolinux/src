...
proc startMount*(mountName: string) =
    ...
    if not dirExists(mount.getSectionValue("Mount", "To")):
        ...
        chmod(mount.getSectionValue("Mount", "To"), parseInt(mount.getSectionValue("Mount", "Chmod", "0755")))
    ...
    cmd = cmd&" "&mount.getSectionValue("Mount", "From")&" "&mount.getSectionValue("Mount", "To")
